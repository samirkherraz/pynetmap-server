...
PROXMOX_UPDATE_INTERVAL = configuration.getint("Statistics", "Refresh")

TUNNEL_HEADER = """killall sshuttle"""
TUNNEL_CORE = """sshuttle -D --pidfile /var/run/sshuttle-pid-[ID] -r [USER]@[IP] [NET] -e 'sshpass -p[PASS] ssh -p [PORT] -o StrictHostKeyChecking=no' """
...
NMAP_MASK = """ awk '/MAC Address:/{printf $3;}/Nmap scan report for/{print "=>"$5";";}' """
